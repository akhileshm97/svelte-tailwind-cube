<section class="vk-landing-section" id="features">
	<div class="container">
		<div class="columns is-multiline is-centered mb-5">
			<div class="column has-text-centered is-9">
				<span class="has-text-grey-dark">Features</span>
				<h2 class="has-text-weight-bold mb-3 is-size-3-mobile mt-2 is-size-2">
					Natural language text mining
				</h2>
				<p class="subtitle has-text-grey">
					Viko's artificial intelligence finds answers in your existing content.
					See our
					<a class="is-underlined" href="/developer/">developer features</a> for
					more information
				</p>
			</div>
		</div>
		<div class="columns is-multiline">
			<div class="column is-6">
				<div class="has-background-light box p-6">
					<div class="has-text-centered">
						<span
							class="is-flex is-align-items-center is-justify-content-center has-background-primary has-text-light mb-4 mx-auto"
							style="width: 56px; height: 56px; border-radius: 50% !important"
							><svg
								viewBox="0 0 32 32"
								fill="none"
							...
							>
								...
								></path></svg
						></span>
						<h3 class="has-text-weight-bold mb-3 is-size-5">
							Surfacing information
						</h3>
						<p class="has-text-grey-dark">
							Unlike FAQs and chatbot flows which are pre-defined, Viko answers
							questions on the fly, using your existing content for context.
						</p>
					</div>
				</div>
			</div>
					...
					<div class="has-text-centered">
						<span
							...
							>
								...
								></path></svg
						></span>
						<h3 class="has-text-weight-bold mb-3 is-size-5">Automatic FAQs</h3>
						<p class="has-text-grey-dark">
							Since Viko sees the questions and accepted answers, we can
							generate SEO compliant FAQs, which are published after approval.
						</p>
					</div>
				</div>
			</div>
					...
					<div class="has-text-centered">
						<span
							...
							>
								...
								></path></svg
						></span>
						<h3 class="has-text-weight-bold mb-3 is-size-5">Fallback routes</h3>
						<p class="has-text-grey-dark">
							Webhooks allow developers to integrate chat and helpdesk systems
							for those occasions where Viko can't answer questions.
						</p>
					</div>
				</div>
			</div>
					...
					<div class="has-text-centered">
						<span
							...
							>
								...
								></path></svg
						></span>
						<h3 class="has-text-weight-bold mb-3 is-size-5">Self learning</h3>
						<p class="has-text-grey-dark">
							The true power of artificial intelligence is the ability to learn
							and improve based on feedback. That's exatly what Viko does.
						</p>
					</div>
				</div>
			</div>
